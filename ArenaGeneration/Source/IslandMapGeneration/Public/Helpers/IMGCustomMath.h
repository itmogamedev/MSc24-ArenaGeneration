...
#include "CustomMathTypes.h"
#include "Components/SplineComponent.h"
#include "IMGCustomMath.generated.h"

/**
 *
 */
UCLASS()
class ISLANDMAPGENERATION_API UIMGCustomMath : public UObject
{
	GENERATED_BODY()
...
private:
	...
	static ELinesOrientation CheckLinesOrientation(FVector P, FVector Q, FVector R);
...
template <class T>
T UIMGCustomMath::GetRandomWeightedClassFromTupleArray(TArray<TTuple<T, float>> TupleArray)
{
...
template <class T>
T UIMGCustomMath::GetBiggestWeightClassFromTupleArray(TArray<TTuple<T, float>> TupleArray)
{
